#!/usr/bin/env python
#
# tomial-clicky-tooth documentation build configuration file, created by
...
version = version("tomial-clicky-tooth")
...
# Add intersphinx mappings for :class:`xxx` cross references to non-tomial_clicky_tooth
# docs.
intersphinx_mapping = {
...
Release history for `tomial-clicky-tooth`.
